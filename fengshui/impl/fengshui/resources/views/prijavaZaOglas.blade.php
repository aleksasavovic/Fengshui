    ...
    <div class="container">
      <div class="row">
        <div class="intro-text">
          <div class="card-body">
             <h2><font color='white'>Prijava Za oglas<font></h2>
                <hr>
              </div>
              <div class="col-md-8 col-md-offset-2">
                ...
                @endif
                <form  method="POST" enctype="multipart/form-data" action="{{ route('prijavaZaOglas') }}">
                  @csrf
           
              <div class="form-group">
              <input type="text" class="form-control" id="vreme_izrade" name="vreme_izrade" placeholder="Vreme izrade (u danima)" value="" required="required">
              </div>
              <div class="form-group">
              <input type="text" class="form-control" id="cena" name="cena" placeholder="Cena (u evrima)" value="" required="required">
              </div>
