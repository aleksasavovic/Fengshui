        ...
        <div class="intro-text">
          ...
          @if(Auth::user()->tipKorisnika=="dizajner")
             ...
             <form  method="POST" enctype="multipart/form-data" action="{{ route('pregledajOglas',$id) }}">
              ...
              <input type="text" class="form-control" id="vreme_izrade" name="vreme_izrade" placeholder="Vreme  potrebno za izradu" value="" required="required">
              </div>
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">                      
                          ...
                          @if($prikazi==1)
                          <br>
                         <form  method="POST" enctype="multipart/form-data" action="{{ route('izaberi',$id,$user->id) }}">
